...
### I am going to run BrLw function a 1000 different times and each time I run it I capture a number that represents how much brownlow will make. Then I will sort the 1000 different number from low to high. At that point I am going ton grab the lower two and a half percent.
...
## Effective Confidence Interval `r low`  to `r high` with average `r middle`
